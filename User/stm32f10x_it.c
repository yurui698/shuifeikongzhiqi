...
void TIM2_IRQHandler(void)
{
	...
	{
		freq_I++;
			if((factory_gateway_set[12] == 7 &&freq_I>MAX_freq_I)|| (factory_gateway_set[15] == 7 &&freq_I>MAX_freq_I)|| (factory_gateway_set[24] == 7&&freq_I>MAX_freq_I)){freq_I=0;}
			if((factory_gateway_set[12] == 33&&freq_I>MAX_SFJ_I) || (factory_gateway_set[15] == 33&&freq_I>MAX_SFJ_I )|| (factory_gateway_set[24] == 33&&freq_I>MAX_SFJ_I)){freq_I=0;}
